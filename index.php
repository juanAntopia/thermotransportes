                                            ...
                                            <div class="ajax-hidden">
                                                ...
                                                <div class="row">
                                                    <div class="form-group col-xs-6 col-md-6">
                                                        ...
                                                        <input type="text" id="c_origen" class="form-control" name="origen" placeholder="Origen" required>
                                                        <div id="origen-status"></div>
                                                    </div>
                                                
                                                    <div class="form-group col-xs-6 col-md-6">
                                                        <label class="sr-only" for="c_location">Destino </label>
                                                        <input type="text" id="c_destino" class="form-control" name="destino" placeholder="Destino" required>
